...
/* EvidenceOS v11.2 — Focus UI */
:root{--page:1040px}
.wrap{max-width:var(--page)}
section{padding:34px 0}
.hero{padding:42px 0 26px}
.hero h1{font-size:clamp(38px,5vw,62px);max-width:800px;margin:16px 0 14px}
.hero .lede{font-size:17px;max-width:680px;margin-bottom:20px}
.hero-card,.metric{display:none!important}
.hero-grid{display:block}
.eyebrow{font-size:12px}
.navlinks{gap:20px}
.nav-more{position:relative}
.nav-more>summary{list-style:none;cursor:pointer;color:var(--muted);font-size:14px}
.nav-more>summary::-webkit-details-marker{display:none}
.nav-more-menu{position:absolute;right:0;top:30px;width:190px;background:#fff;border:1px solid var(--line);border-radius:14px;padding:8px;box-shadow:var(--shadow);z-index:50}
.nav-more-menu a{display:block;padding:9px 10px;border-radius:9px;font-size:13px}
.nav-more-menu a:hover{background:var(--soft)}
.section-title{font-size:28px;margin-bottom:6px}
.section-sub{font-size:14px;max-width:690px;margin-bottom:18px}
.kicker{font-size:10px}
.panel{border-radius:18px;box-shadow:0 7px 24px rgba(16,34,28,.035)}
.searchbox{border-radius:20px;padding:20px;background:var(--brand)}
.searchgrid{gap:10px}
.field{margin-top:12px}
input,textarea{padding:11px 12px}
.actions{margin-top:12px}
.focus-advanced{grid-column:1/-1;margin-top:2px;border-top:1px solid rgba(255,255,255,.16);padding-top:10px}
.focus-advanced>summary{cursor:pointer;font-size:12px;font-weight:750;color:#dcebe5;list-style:none}
.focus-advanced>summary::-webkit-details-marker{display:none}
.focus-advanced>summary:after{content:" +";font-weight:500}
.focus-advanced[open]>summary:after{content:" −"}
.focus-advanced-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:8px}
.focus-advanced .scope-options{margin-top:8px}
.focus-advanced .scope-note{color:#cfe0d8}
.workspace{grid-template-columns:330px 1fr;gap:16px}
.form,.results{padding:18px}
...
.record{padding:11px}
.detail-disclosure{border-top:1px solid var(--line);padding:12px 0}
.detail-disclosure>summary{cursor:pointer;font-weight:750;font-size:13px;color:var(--brand2);list-style:none}
...
.trust-panel{margin-top:14px}
.trust-panel.focus-collapsed{padding:0;border:0;background:transparent}
.project-shell{padding:16px}
.project-grid{grid-template-columns:1fr 1fr auto}
.project-meta{margin-top:10px}
.project-focus-details{margin-top:12px}
.project-focus-details>summary{cursor:pointer;font-weight:700;font-size:12px;color:var(--muted)}
.secondary-section{padding:14px 0}
.secondary-tool{border:1px solid var(--line);background:white;border-radius:16px;padding:0 16px}
.secondary-tool>summary{cursor:pointer;list-style:none;padding:15px 0;font-weight:750;display:flex;justify-content:space-between;gap:16px;align-items:center}
.secondary-tool>summary::-webkit-details-marker{display:none}
.secondary-tool>summary span{font-weight:500;color:var(--muted);font-size:12px}
.secondary-tool[open]>summary{border-bottom:1px solid var(--line)}
.secondary-tool-body{padding:18px 0}
#modules{display:none}
.corpus-bar{gap:12px}
.corpus-actions{gap:7px}
.corpus-focus{margin:10px 0}
.corpus-focus>summary{cursor:pointer;font-size:12px;color:var(--muted);font-weight:700}
.synth-grid{display:block}
.synth-card{padding:16px}
.synth-secondary{margin-top:12px}
.synth-secondary>summary{cursor:pointer;font-weight:750;color:var(--brand2);font-size:13px}
.confidence-grid{grid-template-columns:repeat(5,minmax(0,1fr));gap:7px}
.conf-item{padding:9px}
.outcome-body{padding:13px;margin-top:10px}
.foot{margin-top:18px;padding-top:20px}
...
<body>
<nav><div class="wrap" style="width:100%;display:flex;align-items:center;justify-content:space-between">
<a class="brand" href="#"><span class="mark">E</span>EvidenceOS <span class="alpha">ALPHA</span></a>
<div class="nav-right">
  <div class="navlinks">
    <a href="#ask">Search</a>
    <a href="#workspace">Study</a>
    <a href="#synthesis">Synthesis</a>
    <a href="#project">Project</a>
    <details class="nav-more"><summary>More</summary><div class="nav-more-menu"><a href="#evidenceGraph">Evidence Graph</a><a href="/docs">API docs</a></div></details>
  </div>
  <div class="lang-switch" aria-label="Language"><button type="button" data-lang-choice="en" onclick="setLanguage('en')">EN</button><button type="button" data-lang-choice="it" onclick="setLanguage('it')">IT</button></div>
</div></div></nav>
<main>
<section class="hero"><div class="wrap">
<span class="eyebrow"><span class="dot"></span> Auditable evidence intelligence</span>
<h1>From research question<br>to challenged conclusion.</h1>
<p class="lede">Search, inspect full text, synthesize evidence and test whether the conclusion survives challenge.</p>
<div class="actions" style="max-width:430px"><a href="#ask" style="flex:1"><button class="primary" style="width:100%">Search evidence →</button></a><a href="#workspace"><button class="secondary">Analyse PDF</button></a></div>
</div></section>
...
<p class="section-sub">Start with the question. Confirm only the PICO elements needed for a transparent PubMed search.</p>
<div class="searchbox">
  <div class="searchgrid">
    ...
    <details class="focus-advanced">
      ...
      <div class="field"><label>Search scope</label>
        <div class="scope-options">
          <label class="scope-option"><input type="radio" name="qscope" value="10"><span class="scope-card"><b>Quick</b><span>Up to 10 records</span></span></label>
          <label class="scope-option"><input type="radio" name="qscope" value="25" checked><span class="scope-card"><b>Standard</b><span>Up to 25 records</span></span></label>
          <label class="scope-option"><input type="radio" name="qscope" value="50"><span class="scope-card"><b>Broad</b><span>Up to 50 records</span></span></label>
        </div>
        <div class="scope-note">Scope changes retrieval breadth, not evidence quality or certainty.</div>
      </div>
    </details>
  </div>
  ...
  <div id="searchErr" style="margin-top:10px;color:#ffd7cf;font-size:13px"></div>
</div>
<div id="searchResults" class="search-results"></div>
</div></section>

<section id="workspace"><div class="wrap"><div class="kicker">Study</div><h2 class="section-title">Analyse full text.</h2><p class="section-sub">Upload a PDF. EvidenceOS extracts the evidence record and keeps uncertainty explicit.</p><div class="workspace"><div class="panel form"><h3>Full-text PDF</h3><div class="muted">PDF-only study extraction</div><div class="field"><label>Report ID</label><input id="rid" value="RCT-001"></div><div class="field"><label>Study title</label><input id="ttl" placeholder="Paste the study title"></div><div class="field"><label>Full-text PDF</label>
...
<h2 class="section-title">What does the evidence suggest?</h2>
<p class="section-sub">Combine the studies saved in this project and inspect the outcome-level evidence pattern.</p>
<div class="panel" style="padding:22px">
  ...
  <details class="corpus-focus"><summary>View saved studies</summary><div id="corpusList" style="margin:10px 0 16px"></div></details>
...
<h2 class="section-title">Research workspace.</h2>
<div class="project-shell">
  <div class="project-grid">
    <div class="field" style="margin-top:0"><label>Active project</label><select id="projectSelect" onchange="switchProject(this.value)" style="width:100%;border:1px solid var(--line);border-radius:13px;padding:11px 12px;background:white"></select></div>
  ...
  <details class="project-focus-details">
    <summary>History, storage & portability</summary>
    <div style="margin-top:12px"><div class="block-head"><b>Revision history</b><button class="small-btn" onclick="renderProjectHistory()">Refresh</button></div><div id="projectHistory" class="history-list"></div></div>
    <div class="muted" style="margin-top:10px">Browser persistence is the alpha storage layer. Export the project JSON for a portable backup; imported JSON is validated by the EvidenceOS backend before activation.</div>
...
Object.assign(EOS_IT,{"Search": "Ricerca", "Study": "Studio", "Synthesis": "Sintesi", "More": "Altro", "From research question": "Dalla domanda di ricerca", "to challenged conclusion.": "alla conclusione messa alla prova.", "Search, inspect full text, synthesize evidence and test whether the conclusion survives challenge.": "Cerca, analizza il full text, sintetizza le evidenze e verifica se la conclusione resiste al challenge.", "Search evidence →": "Cerca evidenze →", "Analyse PDF": "Analizza PDF", "Start with the question. Confirm only the PICO elements needed for a transparent PubMed search.": "Parti dalla domanda. Conferma solo gli elementi PICO necessari per una ricerca PubMed trasparente.", "Advanced options": "Opzioni avanzate", "Scope changes retrieval breadth, not evidence quality or certainty.": "L'ampiezza modifica la quantità di record recuperati, non la qualità o la certezza delle evidenze.", "Analyse full text.": "Analizza il full text.", "Upload a PDF. EvidenceOS extracts the evidence record and keeps uncertainty explicit.": "Carica un PDF. EvidenceOS estrae il record di evidenza mantenendo esplicita l'incertezza.", "What does the evidence suggest?": "Cosa suggeriscono le evidenze?", "Combine the studies saved in this project and inspect the outcome-level evidence pattern.": "Combina gli studi salvati nel progetto ed esamina il pattern delle evidenze a livello di outcome.", "View saved studies": "Mostra studi salvati", "Research workspace.": "Workspace di ricerca.", "History, storage & portability": "Cronologia, archiviazione e portabilità", "Evidence Graph": "Grafo delle evidenze", "Provenance & relationships": "Provenienza e relazioni", "Question → studies → outcome bodies → challenges and gap hypotheses. This is a provenance graph, not a causal graph.": "Domanda → studi → body of evidence per outcome → challenge e ipotesi di gap. È un grafo di provenienza, non un grafo causale.", "Study characteristics": "Caratteristiche dello studio", "Technical record": "Record tecnico", "Methodological appraisal": "Appraisal metodologico", "Evidence summary": "Sintesi delle evidenze", "Certainty, contradictions & research gaps": "Certezza, contraddizioni e research gap", "Export": "Esporta"});
...
function render(rec, detectedDesign=null){
 ...
 html.push(`<details class="detail-disclosure"><summary>Study characteristics</summary><div class="block"><h4>Study identity</h4><div class="record">${fieldRow('Design',designField)}${fieldRow('Trial registration',rec.trial_registration)}</div></div><div class="block"><h4>Sample structure</h4>${samples.length?samples.map(s=>`<div class="record"><div class="block-head"><b>${esc(s.role)}</b>${s.total_n?badge(s.total_n.status):''}</div>${fieldRow('Total N',s.total_n)}${(s.arms||[]).map(a=>`<div class="row"><span>${esc(a.label)}</span><div>${a.n?`<b>n=${esc(a.n.value)}</b> ${badge(a.n.status)}`:''}</div></div>`).join('')}</div>`).join(''):'<div class="record muted">No sample structure could be verified.</div>'}</div></details>`);
 html.push(`<details class="detail-disclosure" ${alarms.length?'open':''}><summary>Epistemic alarms${alarms.length?` · ${alarms.length}`:''}</summary>${alarms.length?alarms.map(a=>`<div class="alarm ${esc(a.severity)}"><b>${esc(a.code)}</b><div>${esc(a.message)}</div></div>`).join(''):'<div class="record muted">No internal consistency alarm was triggered for the extracted fields.</div>'}</details>`);
 html.push(`<details class="detail-disclosure"><summary>Technical record</summary><pre style="white-space:pre-wrap;font-size:11px;background:#f7f9f8;padding:14px;border-radius:12px;overflow:auto">${esc(JSON.stringify(rec,null,2))}</pre></details>`);
...
function renderSynthesis(d){
 ...
 <div class="synth-card" style="margin-bottom:12px"><div class="kicker">Evidence summary</div><h3 style="font-size:25px;margin:4px 0">${esc(d.headline)}</h3><div class="muted">${esc(d.interpretation_boundary)}</div></div>
 <div class="synth-card"><div class="kicker">Outcome bodies</div>${outcomes||'<div class="muted">No outcome-level evidence available.</div>'}</div>
 <details class="synth-card synth-secondary"><summary>Certainty, contradictions & research gaps</summary>
   ...
   <div style="margin-top:16px"><div class="kicker">Contradictions</div>${contradictions||'<div class="muted">No explicit directional contradiction detected.</div>'}</div>
   <div style="margin-top:16px"><div class="kicker">What remains uncertain?</div>${gaps||'<div class="muted">No broad uncertainty automatically detected.</div>'}<div style="margin-top:12px"><b>Falsifiable gap hypotheses</b><div class="muted">EvidenceOS treats each apparent gap as a hypothesis and actively searches for counterevidence before calling it a research opportunity.</div>${gapHyp||'<div class="record muted">No falsifiable gap hypothesis generated from this corpus.</div>'}</div></div>
 </details>`;
}
...
function renderTrustAssessment(t){
 ...
 return `<details class="detail-disclosure" style="margin-top:14px"><summary>Methodological appraisal · ${esc(t.headline)}</summary><div class="trust-panel"><div class="trust-head"><div><div class="kicker">How much can we trust this study?</div><h3 class="trust-title">${esc(t.headline)}</h3><div class="muted">Detected design: ${esc(t.design)}</div></div>${framework}</div><div class="trust-banner">${esc(t.explanation)}</div>${genericDomains?`<div class="rob-grid">${genericDomains}</div>`:''}${outcomes}${limitations}</div></details>`;
}
